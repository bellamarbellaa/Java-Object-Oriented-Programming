...
public class Die{
    ...
    //-----------------------------------------------------------------
    // Face value mutator or setter.  The face value is not modified if the
    ...
    public static void main(String[] args){
        Die myDie = new Die();
        System.out.println("New face :"+myDie.roll());
        System.out.println("Face value :"+myDie.getFaceValue());
    }
 }
